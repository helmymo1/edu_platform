...
import { CheckCircle, BookOpen, ArrowRight, Calendar, Video } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Confirming your booking...</h2>
          <p className="text-gray-600">Please wait while we secure your spot in the live lesson.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">{error || 'There was an issue processing your booking.'}</p>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                ...
                <>
                  <a href="/account/signin" className="text-gray-700 hover:text-blue-600 font-medium">Sign In</a>
                  <a href="/account/signup" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                    Get Started
                  </a>
                </>
              )}
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            You're All Set for Your Live Lesson!
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Your booking was successful. Get ready for an interactive learning experience!
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-md p-6 text-left">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">View Your Schedule</h3>
              <p className="text-gray-600 mb-4">
                Check your upcoming live lessons and manage your learning schedule.
              </p>
              <a
                href="/dashboard"
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-left">
              ...
              <p className="text-gray-600 mb-4">
                Complement your live learning with self-paced courses from our library.
              </p>
              <a
                href="/courses"
                className="flex items-center text-purple-600 hover:text-purple-700 font-medium"
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Add the lesson to your calendar and set a reminder 15 minutes before.
                </p>
              </div>
              <div>
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Join Link Ready</h4>
                <p className="text-gray-600 text-sm">
                  The meeting link will be available in your dashboard 30 minutes before the lesson.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Have your questions ready and any materials mentioned in the lesson description.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Real-time interaction with your instructor and fellow students through video, audio, and chat.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Hands-on Practice</h4>
                  <p className="text-gray-600 text-sm">Follow along with coding exercises, projects, and real-world examples.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Get your questions answered and receive personalized feedback on your progress.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-sm text-gray-500">
            <p>
              📧 A confirmation email with lesson details and meeting instructions has been sent to your email address.
            </p>
          </div>
        </div>
      </div>
